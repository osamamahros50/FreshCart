              ...
              >
                ...
                <div className="layer absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2  flex justify-between gap-6">
                  ...
                  <div
                    ...
                    className="icon hover:animate-bounce translate-y-20 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition duration-600 bg-main cursor-pointer hover:bg-green-800 text-slate-200 p-3 rounded-full"
                  >
                    <ShoppingCart />
                  </div>
                  <div className="icon hover:animate-bounce translate-y-20 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition duration-900 bg-main cursor-pointer hover:bg-green-800 text-slate-200 p-3 rounded-full">
